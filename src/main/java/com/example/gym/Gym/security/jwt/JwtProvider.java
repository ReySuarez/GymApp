...
public class JwtProvider {
    ...
    @Value("${jwt.secret:MientrasElEjercitoDroideSeparatistaTrataDeHuirDeLaCapitalSitiadaConSuValiosoRehenDosCaballerosJediLideranUnaMisionDesesperadaParaRescatarAlCancillerCautivo}")
    ...
    public boolean validateToken(String authToken) {
        try {
            ...
            log.info("Formato del Token erroneo: " + ex.getMessage());
        } catch (ExpiredJwtException ex) {
            log.info("El token expirado: " + ex.getMessage());
